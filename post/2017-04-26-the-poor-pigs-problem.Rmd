...
###Follow Up
If pigs die within m minutes and we are given p minutes, then the number of test rounds is $\lfloor{p}{m}\rfloor$. Out of these, $\lfloor{p}{m}\rfloor - 1$ rounds are used to divide buckets into groups and zoom in on the general location of the poison. Equation \@ref(eq:maxbuckets) can then be generalized to
