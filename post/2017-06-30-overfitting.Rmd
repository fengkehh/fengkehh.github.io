...
slug: ''
categories: ['Posts']
tags: ['R', 'Beginner', 'Overfitting', 'Machine Learning', 'Decision Tree']
output:
  blogdown::html_page:
    toc: true
---
...
I am now going to train three decision tree models using the training sets, each demonstrating a different aspect.
