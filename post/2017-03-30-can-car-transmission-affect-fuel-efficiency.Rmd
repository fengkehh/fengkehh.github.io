...
slug: ''
categories: ['Projects']
tags: ['Multivariate Linear Regression', 'Residual Analysis', 'Hypothesis Test']
...
Scatter plots showing the effect of non-categorical variables on MPG are shown in Figure \@ref(fig:non-categorical)

```{r non-categorical, fig.cap = 'MPG vs Non-Categorical Variagbles'}
par(mfrow = c(3,2))
